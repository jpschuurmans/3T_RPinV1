...
#dataPath = 'data'
stimPath = 'stimuli'
noisePath = 'noiseFrames'
seqLocation = 'sequence_withinBlock.txt'

#commented out, this is just for testing in Spyder
#dataPath = 'C:\\Users\\jolien\\Documents\\3T_RPinV1\\MainExp_ToTest\\data'
#stimPath = 'C:\\Users\\jolien\\Documents\\3T_RPinV1\\MainExp_ToTest\\stimuli'
#noisePath = 'C:\\Users\\jolien\\Documents\\3T_RPinV1\\MainExp_ToTest\\noiseFrames'
#seqLocation = 'C:\\Users\\jolien\\Documents\\3T_RPinV1\\MainExp_ToTest\\sequence_withinBlock.txt'
...
expInfo = {
        ...
        '3. Fixation type': ('screenwide cross','small "normal" cross')
        }
...
#fixationcross settings
if expInfo['3. Fixation type'] == 'screenwide cross':
    fixtype = 0
elif expInfo['3. Fixation type'] == 'small "normal" cross':
    fixtype = 1
    
# make a text file to save data with 'comma-separated-values'
dataName = expInfo['1. Participant ID'] + '_run' + expInfo['2. Run number'] + '_' + expInfo['date']
...
if fixtype == 1:
    ...
    fix1=visual.Line(win,start=(-scrsize[0],-scrsize[1]),end=(scrsize[0], scrsize[1]),
                     pos=(0.0, 0.0),lineWidth=1.0,lineColor='black',units='pix')
    fix2=visual.Line(win,start=(-scrsize[0],scrsize[1]),end=(scrsize[0], -scrsize[1]),
                     pos=(0.0, 0.0),lineWidth=1.0,lineColor='black',units='pix')
...
elif fixtype == 0: #for different fixation cross
...
for trial in trialsReady:
    ...
    if trial['catchTrial'] == True: #if its a catchtrail, start the clock
        ...
        print('Response time is ', response_time, ' and the reactiontime is: ', reactionTime, 'ms' )
...
toSave = 'percentage correct = ' + str(percCorr)
logfile.write(toSave)
